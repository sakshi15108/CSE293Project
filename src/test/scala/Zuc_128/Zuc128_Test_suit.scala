...
object zuc128_ScalaModelTestData1{
  ...
  val KSlen : Int = 32
  val Z_post_gen_Klen1: Seq[Int] = Seq(0x27bede74)
...
object zuc128_ScalaModelTestData2{
  ...
  val KSlen : Int = 32
  val Z_post_gen_Klen1: Seq[Int] = Seq(0x657cfa0)
...
object zuc128_ScalaModelTestData3 {
  ...
  val KSlen : Int = 32
  val Z_post_gen_Klen1: Seq[Int] = Seq(0x14f1c272)
...
object zuc128_ScalaModelTestData4 {
  ...
  val KSlen : Int = 32
  val Z_post_gen_Klen1: Seq[Int] = Seq(0xed4400e7)
